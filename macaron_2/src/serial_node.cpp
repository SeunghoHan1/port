...
#include <macaron_2/erp42_read.h>
...
//콜백 함수 선언
void writeCallback(const macaron_2::erp42_write::ConstPtr& write)
{
    inputbool = 1;
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    ros::Publisher  serial_pub = nh.advertise<macaron_2::erp42_read>("erp42_read", 1);
    ros::Subscriber serial_sub = nh.subscribe("erp42_write", 1, writeCallback);
    ros::Rate loop_rate(50);
    macaron_2::erp42_read erp42_state;
    //serial setting
    try
    {
